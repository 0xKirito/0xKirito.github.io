...
img_path: /assets/img/writeups/beep/
...
- `searchsploit openssh 4.3` => mostly username enumeration
...
- `/vtigercrm` looked interesting. On visiting the page, I could see the version number => vtiger CRM 5.1.0.
- `searchsploit vtiger crm 5.1` => LFI
